...
/// 진입 기본 = 좌 사이드바만(A109 → A273/v0.271.0에서 좌 열림·우 닫힘으로 개정).
    ...
    ITrayStatusProvider, ISidebarAwareView, ISidePanelProvider
{
    ...
    /// 초기값 8 = 도크 0(전폭) 기준. 정보 모듈 진입 기본(A109 → A273/v0.271.0: 좌 사이드바만)은
    /// 뷰 교체 직후 셸의 첫 푸시가 6열로 잡는다 — 초기값이 화면에 남는 구간은 없다.</summary>
