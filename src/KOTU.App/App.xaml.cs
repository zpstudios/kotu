...
public partial class App : Application
{
    ...
    protected override void OnLaunched(LaunchActivatedEventArgs args)
    {
        ...
        // 업데이트 전역 상태 준비 — 저장된 마지막 확인 결과를 읽고 자동 확인 타이머를 켠다
        // (A114, v0.136.0: 첫 확인도 2분 뒤·이후 2분 간격, 프로세스당 타이머 1개).
        // 설정 화면 진입 1회도 같은 코디네이터로 모인다(A125/v0.148.0에서 수동 버튼 경로는 제거 —
        // 자동 확인 두 경로만 남았다). 새 버전을 찾아도 토스트는 없다.
