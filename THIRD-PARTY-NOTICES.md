...
| 구성요소 | 용도 | 라이선스 | 비고 |
|---|---|---|---|
| [7-Zip](https://www.7-zip.org/) `7z.dll` | 압축 해제/생성 엔진 | LGPL-2.1 (+ unRAR 제한) | 동적 로드만 사용. 저장소에 미포함 — 사용자가 별도 취득 |
...
| 구성요소 | 용도 | 라이선스 |
|---|---|---|
| [libvlc / LibVLCSharp](https://code.videolan.org/videolan/LibVLCSharp) | 동영상 재생 | LGPL-2.1 |
